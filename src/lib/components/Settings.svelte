  ...
  <form action="#">
    <label for="themePicker">
      <select
        ...
        required
      >
        <option value="default" selected={currentTheme === "default"}
          >Default (Light/Dark)</option
        >
        <option value="custom" selected={currentTheme === "custom"}
          >Custom (Light/Dark)</option
        >
        <option value="green" selected={currentTheme === "green"}
          >Green (Light/Dark)</option
        >
      </select>
    </label>
